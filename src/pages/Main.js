...
const Main = () => {
  ...
  return (
    <div className="container main">
      <header>
        <div className="logo"><a href="/main"><img src={logoHeader} alt="kikiB" /></a></div>
        <p className="page-title">메인화면</p>
        <div className="btn-box">
          <a href="#" className="btn-search"><img src={icoSearch} alt="검색" /></a>
          <a href="#" className="btn-msg"><img src={icoMsg} alt="메시지" /></a>
        </div>
      </header>

      <div className="user-box">
        {/* <h1>{userName} {error ? `?` : busRouteData}번 승무원님</h1> //디자인 버스번호 없어서 주석처리 */}
        <div className="logo"><img src={logoBus} alt="" /></div>
        <h1><span>삼영운수</span> {userName}님</h1>
        <a href="" className="btn-timetable">출근부</a>
      </div>
        ...
        <div className="daily-box">
          <div className="box-inner">
            <div className="item date">
              <Clock className="first" format={'MM월DD일'} ticking={true} timezone={'Asia/Seoul'} /><br/>
              <Clock className="second" format={'dddd'} ticking={true} timezone={'Asia/Seoul'} />
            </div>
            <div className="item clock">
              <Clock className="first" format={'A'} ticking={true} timezone={'Asia/Seoul'} /><br/>
              <Clock className="second" format={'hh:mm'} ticking={true} timezone={'Asia/Seoul'} />
            </div>
        ...
        */}
        <ul className="menu-list">
          <li className="type-cell">
            <a href="/management" className="btn-common" component={busRouteData}>
              <span className="menu-title">근무<br/>일정</span>
          ...
          <li className="type-cell">
            <a href="#" className="btn-common" onClick={() => alert('준비중인 기능입니다.')}>
              <span className="menu-title">배차<br/>일보</span>
          ...
          <li className="type-cell">
            <a href="#" className="btn-common btn-disabled" onClick={e => e.preventDefault}>
              <span className="menu-title">차량<br/>관리</span>
          ...
          <li className="type-cell">
            <a href="#" className="btn-common" onClick={e => e.preventDefault}>
              <span className="menu-title">운행<br/>분석</span>
      ...
      <nav className="nav">
        <ul className="nav-list">
          <li className="on"><a href="#"><span className="blind">홈</span></a></li>
          <li><a href="/management"><span className="blind">근무관리</span></a></li>
          <li><a href="#"><span className="blind">배차일보</span></a></li>
          <li><a href="#"><span className="blind">사용자설정</span></a></li>
        </ul>
      </nav>
    </div>
  );
